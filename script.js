...
function getTrainingConfig(){
  return {
    optimizer: document.getElementById('opt') ? document.getElementById('opt').value : 'Adam',
    learningRate: Number(document.getElementById('lr') ? document.getElementById('lr').value : 0.001),
    loss: document.getElementById('lf') ? document.getElementById('lf').value : 'CrossEntropyLoss',
    epochs: Number(document.getElementById('ep') ? document.getElementById('ep').value : 30),
    batchSize: Number(document.getElementById('bs') ? document.getElementById('bs').value : 32),
    dataset: document.getElementById('ds') ? document.getElementById('ds').value : 'Synthetic',
  };
}
